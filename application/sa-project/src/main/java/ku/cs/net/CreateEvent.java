...
public class CreateEvent {
    public void createEvent(String eventName, LocalDateTime startDateTime, LocalDateTime endDateTime, String description) throws URISyntaxException, IOException {
